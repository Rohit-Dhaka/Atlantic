...
const HeroSection = () => {
    return (
        <header className='hero-background min-vh-100 d-flex flex-column position-relative  overflow-hidden '>
            ...
            <nav class="navbar navbar-expand-xl bg-body-tertiary"  data-aos="fade-down">
                <div class="container max-w-1360">
                    ...
                    <div class="collapse navbar-collapse mt-xl-0 mt-3" id="navbarSupportedContent" >
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex gap-28 ">
                            <li class="nav-item">
                                <a class="nav-link active " aria-current="page" href="#about" className='text-white fw-normal fs-16 lh-24 ff-dm-sans underline position-relative'>About Us</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link disabled" aria-disabled="true" href='#Services' className='text-white fw-normal fs-16 lh-24 ff-dm-sans underline position-relative'>Services</a>
                            </li> 
                            <li class="nav-item">
                                <a class="nav-link disabled" aria-disabled="true"  href='#Testimonials' className='text-white fw-normal fs-16 lh-24 ff-dm-sans underline position-relative'>Testimonials</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link disabled" aria-disabled="true"  href='#blog' className='text-white fw-normal fs-16 lh-24 ff-dm-sans underline position-relative'>Blogs</a>
                            </li>
                        </ul>
