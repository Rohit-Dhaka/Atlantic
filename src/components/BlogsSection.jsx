...
const BlogsSection = () => {
    return (
        <section className='bg-black  position-relative '   id='blog'>
            ...
            <div className="container max-w-1140">
                <div className="d-flex justify-content-center" data-aos="zoom-in">                    
                    <h2 className=' text-uppercase text-white ff-poppins fw-extra-bold fs-52 lh-62 mb-0  max-w-578 text-center'>explore our<span className="fw-normal   position-relative  z_1   bg-blog">  <em> blogs </em></span></h2>
                </div>
